...
public class Menu extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        imageAvatar1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/Boitier.jpg"))); // NOI18N

        jLabel1.setFont(new java.awt.Font("sansserif", 1, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(224, 224, 224));
        jLabel1.setText("PIMP MY FRIDGE");

        jLabel2.setForeground(new java.awt.Color(203, 203, 203));
        jLabel2.setText("Groupe 9");
